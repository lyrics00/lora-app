...
urlpatterns = [
    ...
    path("collection/<int:pk>/add-item/", views.collection_add_item, name="collection_add_item"),
    path("collection/<int:pk>/remove-item/", views.collection_remove_item, name="collection_remove_item"),
    ...
    path('item/<int:pk>/borrow/', views.borrow_item, name='borrow_item'),
