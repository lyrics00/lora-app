...
urlpatterns = [
    ...
    path("active-borrowed-items/", views.view_active_borrowed_items, name="view_active_borrowed_items"),
    path("return/<int:pk>/", views.return_borrowed_item, name="return_borrowed_item"),
